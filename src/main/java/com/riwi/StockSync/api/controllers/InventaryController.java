...
public class InventaryController {
    ...
    @Operation(summary = "List all existing inventories in a store", description = "Retrieve all inventories related to a store along with their information (name, location).")
    @GetMapping
    ...
    @Operation(summary = "Show the inventory that belongs to that id.", description = "Retrieve the inventory related to a store.")
    @GetMapping(path = "/{id}")
    ...
    @Operation(summary = "Create an inventory.", description = "Create an inventory for a specific store requiring the following data: store id and creation date.")
    @PostMapping
    ...
    @Operation(summary = "Delete an inventory.", description = "Delete a specific inventory by passing its id.")
    ...
    @Operation(summary = "Update an inventory.", description = "Update a specific inventory by passing its id and returning the updated inventory.")
    @PutMapping(path = "/{id}")
